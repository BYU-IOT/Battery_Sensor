...
const char  AutoConnect::_PAGE_CONFIGNEW[] PROGMEM = {
  ...
  "<input id=\"servername\" type=\"text\" name=\"" AUTOCONNECT_PARAMID_SERVER_NAME "\" placeholder=\"ServerName\">" //.........changable server ip/name
  "</li>"
  "<li>"
  "<label for=\"sensorname\">SensorName</label>"
  "<input id=\"sensorname\" type=\"text\" name=\"" AUTOCONNECT_PARAMID_SENSOR_NAME "\" placeholder=\"SensorName\">" //.........name for sensor
  "</li>"
  "<li>"
  "<label for=\"interval\">DataInterval</label>"
  "<input id=\"interval\" type=\"text\" name=\"" AUTOCONNECT_PARAMID_INTERVAL "\" placeholder=\"DataInterval\">" //.........data collection interval
  "</li>"
  "<li>"
  "<label for=\"adcFrq\">ADCFrq</label>"
  "<input id=\"adcFrq\" type=\"text\" name=\"" AUTOCONNECT_PARAMID_ADCFRQ "\" placeholder=\"ADCFrq\">" //.........data collection adcFrq
  "</li>"
