...
String AutoConnect::_induceConnect(PageArgument& args) {
  ...
  if (args.hasArg(String(F(AUTOCONNECT_PARAMID_CRED)))) {
    ...
    strncpy(reinterpret_cast<char*>(_credential.serverName), args.arg(String(F(AUTOCONNECT_PARAMID_SERVER_NAME))).c_str(), sizeof(_credential.serverName)); //........... store serverName in object
    strncpy(reinterpret_cast<char*>(_credential.sensorName), args.arg(String(F(AUTOCONNECT_PARAMID_SENSOR_NAME))).c_str(), sizeof(_credential.sensorName)); //........... store sensorName in object
    strncpy(reinterpret_cast<char*>(_credential.interval), args.arg(String(F(AUTOCONNECT_PARAMID_INTERVAL))).c_str(), sizeof(_credential.interval)); //........... store interval in object
    strncpy(reinterpret_cast<char*>(_credential.adcFrq), args.arg(String(F(AUTOCONNECT_PARAMID_ADCFRQ))).c_str(), sizeof(_credential.adcFrq)); //........... store adcFrq in object
  }
